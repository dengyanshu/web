...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    createDesktopMenu: function () {
        ...
        if (ret.items.length) {
            ...
            ret.items.push(
              { text: '刷新', handler:function(){window.location.reload();}, scope: me, minWindows: 1 },
            	'-');
        }
...
// 		alert(id);
        ...
        if(record.get("nodeInfoType")=="MENU"){		//如果文件夹中的图标点击是菜单
        	id="folderview_win";										//设定ID 高度和宽度
...
//        me.windows.remove(win);
    ...
    onWindowMenuClose: function (win) {
