...
var store = Ext.data.StoreManager
		.get('core.xigao.store.viewList.MOName_SMT_ViewList_Store');

Ext.define("core.xigao.view.main.content.viewList.MOName_SMT_ViewList_View", {
	extend : 'Ext.Window',
	width : 600,
	height : 400,
	closable:true,
	...
	items : [{
		...
		store : Ext.data.StoreManager
				.lookup('core.xigao.store.viewList.MOName_SMT_ViewList_Store'),
		columns : [{
					header : 'rowNum',
					dataIndex : 'rowNum',
					width : 100
		...
		listeners : {
			...
			itemclick : function(record, item, index, e, eOpts) {
				...
				var pd = record.getSelectionModel().selected.items[0].raw['ProductDescription'];
				result[0] = mo;
				result[1] = pn;
				result[2] = moid;
				result[3] = pd;
