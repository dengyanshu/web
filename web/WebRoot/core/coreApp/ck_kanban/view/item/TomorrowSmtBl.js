Ext.define("core.ck_kanban.view.item.TomorrowSmtBl", {
			extend : "Ext.grid.Panel",
			alias : 'widget.ck_tomorrow_smt_bl_kb',
			loadMask : true, 
			stripeRows : true,
			store : 'core.ck_kanban.store.tomorrow_bl.smt.Store',
			columns : [
					...
					},
					{
						...
						header : '已备总数/应备总数',
						dataIndex : 'AbsoluteCompleteRate',
						width : 260,
						renderer : function(value) {
							return Ext.create("core.util.model.KanBanProgressStatus").ProgressStatus(value);
						}
