...
Ext.define("core.sx_line_kanban.controller.Controller", {
	...
	init : function() {
		...
		coreApp = self;				
		this.control({
			'sx_line_kanban_search button[ref=submit]':{
			   click:function(e,Opts){
		          ...
		          var   line=ser.getForm().findField('line').getValue();
					...
					var store = Ext.data.StoreManager.map['core.sx_line_kanban.store.Store'];
					store.removeAll();
	...
	views : ['core.sx_line_kanban.view.Main',
	'core.sx_line_kanban.view.ResultView',
	'core.sx_line_kanban.view.SearchView',
	'core.sx_line_kanban.view.ChartView'
	],
		
	stores : ['core.sx_line_kanban.store.Store'
	],
	
	models : ['core.sx_line_kanban.model.Model']
});
