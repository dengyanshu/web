Ext.define("core.sx_line_kanban.view.ResultView",{
	extend:'Ext.grid.Panel',
	region:'center',
	alias:'widget.sx_line_kanban_listview',
	...
	columns : [
	       {header : '时间',dataIndex : 'time',width : 190,renderer:rendererFather
			...
			{header : 'BC',dataIndex : 'BC',width : 140,renderer:rendererFather
			    ,summaryType: 'sum'
			}, 
			{header : 'MWT',dataIndex : 'MWT',width : 140,renderer:rendererFather
			   ,summaryType: 'sum'
			},
			//{header : 'CSP',dataIndex : 'CSP',width :140,renderer:rendererFather},
			{header : 'CST',dataIndex : 'CST',width :140,renderer:rendererFather
			,flex:1
			     ,summaryType: 'sum'
			}
	]
