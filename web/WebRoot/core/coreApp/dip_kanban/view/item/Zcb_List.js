Ext.define("core.dip_kanban.view.item.Zcb_List",{
	extend:'Ext.window.Window',	
	frame:true,
	alias : 'widget.dip_zcb_list_kb',
	width:500,
	maximized:true,
    layout: 'border',
    title:'生产报表',
    items:[
    	{
    		xtype:'grid',
    		store:'core.dip_kanban.store.zcb.ListStore',
    		//frame:true,
    		collapsible:true,
    		height:370,
...
//    					var str=value.toString();return str.substring(1,str.length);}else{return "0";}}},
    			{text:'差异值',dataIndex:'cy',width:150,renderer:function(value){
    	...
    	{
    		xtype:'grid',
    		store :'core.dip_kanban.store.zcb.Store2',
    		region:'north',
    		height:57,
    		
    		columns : [
    		        {header : '序号',dataIndex : 'RowNum',flex : 0.4,hidden:true},
   					{header : '线别',dataIndex : 'WorkcenterName',flex : 1.4},
   					{header : '产出',dataIndex : 'SumYield',flex : 1.3},
   					{header : '工时',dataIndex : 'SumTime',flex : 1.3},
   					{header : 'UPH',dataIndex : 'UPH',flex : 1.3},
