Ext.define("core.smt_xbc_kanban.view.MoView",{
	extend:'Ext.grid.Panel',
	alias:'widget.smt_xbc_kb_moview',
	store:'core.smt_xbc_kanban.store.sl.Store',
	columns : [
			{header : '序号',dataIndex : 'Num',width : 40},
			{header : '工单',dataIndex : 'MOName',width : 125},
	...
	tbar:[
		{xtype:'button',text:'返回',action:'return2'}
	],
	viewConfig:{
		forceFit:true,
		enableRowBody:true,
