Ext.define("core.tj_sc_kanban.view.item.SmtSc_List",{
	extend:'Ext.window.Window',	
	frame:true,
	alias : 'widget.tj_sc_smt_list_kb',
	width:500,
	maximized:true,
    layout: 'border',
    title:'生产报表',
    items:[
    	{
    		xtype:'grid',
    		store:'core.tj_sc_kanban.store.smt.ListStore',
    		//frame:true,
    		collapsible:true,
    		height:370,
    		region:'south',
    	...
    	{
    		xtype:'grid',
    		store :'core.tj_sc_kanban.store.smt.Store2',
    		region:'north',
    		height:73,
