Ext.define("core.smt_sb2_kanban.view.item.zj_List",{
	extend:'Ext.window.Window',	
	frame:true,
	alias : 'widget.smtsb2_zj_list_kb',
	width:500,
	maximized:true,
    layout: 'fit',
    title:'治具历史记录',
    items:[
    	{
    		xtype:'grid',
    		store:'core.smt_sb2_kanban.store.zj.ListStore',
    		//frame:true,
    		//collapsible:true,
    		height:370,
    		//region:'south',
    		columns:[
    			{text:'治具编号',dataIndex:'治具编号',width:'9%'},
