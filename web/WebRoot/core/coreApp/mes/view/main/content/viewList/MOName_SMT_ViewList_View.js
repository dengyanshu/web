...
var store = Ext.data.StoreManager
		.get('core.mes.store.viewList.MOName_SMT_ViewList_Store');

Ext.define("core.mes.view.main.content.viewList.MOName_SMT_ViewList_View", {
	extend : 'Ext.Window',
	width : 600,
	height : 400,
	closable:true,
	...
	items : [{
		...
		store : Ext.data.StoreManager
				.lookup('core.mes.store.viewList.MOName_SMT_ViewList_Store'),
		columns : [{
					header : 'rowNum',
					dataIndex : 'rowNum',
					width : 100
