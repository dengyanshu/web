 ...
 ***************************************************************************/
   ...
   Ext.define("core.mes.view.main.content.reportforms.dip_wx.Result",{
   	extend:"core.mes.base.BaseGrid",
 	alias:'widget.dip_wx.result',
	store:'core.mes.store.reportforms.dip_wx.Store',		
	columns:[  
		{xtype: 'rownumberer',header:'序号',width : 50,align:'center'},
		{header:"维修入库时间",width:100,dataIndex:'维修入库时间',sortable:true},
		{header:"维修时间",width:100,dataIndex:'维修时间',sortable:true},
		{header:"维修出库时间",width:100,dataIndex:'维修出库时间',sortable:true},
		{header:"VendorLotSN",width:100,dataIndex:'VendorLotSN',sortable:true},
