 ...
 ***************************************************************************/
  ...
  Ext.define("core.mes.view.main.content.reportforms.smt_sljl.Operate",{
  	extend:"core.mes.base.BaseForm",
 	alias:'widget.smt_sljl.operate',
	items:[{
		xtype : 'searchgrid',
		// emptyText:'请输入工单',
		//value:'MO010112040003',
		fieldLabel : '工单',
		name : 'smt_sljl_mo',
		allowBlank : false,
		width : 255,
