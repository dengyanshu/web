Ext.define("core.hw_line_kanban.view.MoView",{
	extend:'Ext.grid.Panel',
	alias:'widget.hw_line_kb_moview',
	store:'core.hw_line_kanban.store.sl.Store',
	columns : [
			{header : '序号',dataIndex : 'Num',width : 40},
			{header : '工单',dataIndex : 'MOName',width : 135},
			//{header : '产品料号',dataIndex : 'ProductName',width : 95}, 
			{header : '卓翼料号',dataIndex : 'CustomerModel',width : 95}, 
			{header : '需求数量',dataIndex : 'MOQtyRequired',width : 65},
			{header : '完工数',dataIndex : 'CompleteQTY',width : 100},
			{header : '未完数',dataIndex : 'UnComplete',width : 100},
			{header : '效率',dataIndex : 'Efficiency',width : 100},
