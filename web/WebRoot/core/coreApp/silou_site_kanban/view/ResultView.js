Ext.define("core.silou_site_kanban.view.ResultView",{
	extend:'Ext.grid.Panel',
	region:'center',
	alias:'widget.silou_site_kanban_listview',
	...
	columns : [
			...
			{header : '当班累计',dataIndex : '累计',flex : 1,align:'center',renderer:rendererFather}
	]
});
