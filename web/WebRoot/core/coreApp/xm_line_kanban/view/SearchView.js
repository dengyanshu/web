...
Ext.define("core.xm_line_kanban.view.SearchView", {
			extend : 'Ext.form.Panel',
			alias : 'widget.xm_line_kanban_search',
			region : 'north',
			bodyPadding : 5,
		        ...
		        },
		        {
		        ...
		        },
		         {
		        	...
		        	store:Ext.create("Ext.data.Store",{
		        		...
		        		data:[
		        			{"statusK":'L01',"statusV":'小米自动化一线'},
		        			{"statusK":'L02',"statusV":'小米自动化二线'},
		        			{"statusK":'L03',"statusV":'小米自动化三线'}
