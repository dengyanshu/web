 ...
 */
Ext.define('core.ux.form.LiveSearchGridPanelCombo', {
    extend: 'Ext.grid.Panel',
    alias:'widget.livesearchgridpanelcombo',
    requires: [
    ...
    //defaultStatusText: 'Nothing Found',   //默认状态下提示的文字
     ...
     onTextFieldChange: function() {
         ...
         if (me.searchValue !== null) {
             ...
             if (me.currentIndex !== null) {
                 ...
                 me.statusBar.setStatus({
                    // text: count + ' matche(s) found.',  //匹配了多少结果
