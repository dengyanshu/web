 ...
 *  author: jesus
 */
Ext.define('core.ux.form.GridComboBoxList', {
	extend : 'Ext.view.AbstractView',
	alias : 'widget.gridcombolist',
	//alternateClassName : 'Ext.GridComboBoxList',
	alternateClassName : 'GridComboBoxList',
	//  Ext4.1下的Bug的解决
	...
	initComponent : function() {
		...
		me.grid = Ext.create('core.ux.form.LiveSearchGridPanelCombo', me.gridCfg);

		//me.grid.initComponent();
