...
public class MOName_ViewList_Android extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		try {
			...
			stmt=conn.prepareCall("{call MOName_ViewList_Android(?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			...
			stmt.setString("LotSN", "");
			stmt.setString("QueryParameter", this.key);
