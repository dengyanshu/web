...
public class All extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		try {
			...
			String sql="SELECT  MO.MOName, ProductRoot.ProductName ,Product.ProductDescription," +
					"ProductFamily.ProductFamilyShortName " +
					"FROM MO " +
					"INNER JOIN Product  ON MO.ProductId = Product.ProductId " +
					"INNER JOIN ProductRoot ON Product.ProductRootId = ProductRoot.ProductRootId " +
					"INNER JOIN ProductFamily ON ProductRoot.ProductFamilyId=ProductFamily.ProductFamilyId " +
					"WHERE (MO.MOStatus = '3')  ORDER BY MO.MOName ";
			//得到结果集
