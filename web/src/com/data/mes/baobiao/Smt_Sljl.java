...
public class Smt_Sljl extends ActionSupport{
	private String smt_sljl_mo;
	private List data;
	...
	public String execute() throws Exception{
		...
		try {
			...
			stmt.setString("MOName", this.smt_sljl_mo);
	...
	public void setSmt_sljl_mo(String smt_sljl_mo) {
		this.smt_sljl_mo = smt_sljl_mo;
	}	
