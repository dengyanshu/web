...
public class Gdwlblmx extends ActionSupport{
	private String gdwlblmx_mo;
	private List data;
	...
	public String execute() throws Exception{
		...
		try {
			...
			stmt=conn.prepareCall("{call QMOReadyLot_DoMethod(?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			...
			stmt.setString("MOName", this.gdwlblmx_mo);
	...
	public void setGdwlblmx_mo(String gdwlblmx_mo) {
		this.gdwlblmx_mo = gdwlblmx_mo;
	}	
