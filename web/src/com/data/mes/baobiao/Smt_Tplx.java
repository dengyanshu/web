...
public class Smt_Tplx extends ActionSupport{
	public String getSmt_tplx_mo() {
		return smt_tplx_mo;
	}



	public void setSmt_tplx_mo(String smt_tplx_mo) {
		this.smt_tplx_mo = smt_tplx_mo;
	}

	private String smt_tplx_mo;
	...
	public String execute() throws Exception{
		...
		try {
			...
			stmt=conn.prepareCall("{call GetMOSMTPath(?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			...
			stmt.setString("MOName", this.smt_tplx_mo);
