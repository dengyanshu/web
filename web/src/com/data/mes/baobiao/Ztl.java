...
public class Ztl extends ActionSupport{
	
	private String ztl_mo;
	private String ztl_begin;
	private String ztl_end;
	private List data;
	...
	public String execute() throws Exception{
		...
		try {
			...
			stmt=conn.prepareCall("{call ShowYield(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			...
			stmt.setString("WO", this.ztl_mo);
			stmt.setString("timeBegin", this.ztl_begin);
			stmt.setString("timeEnd", this.ztl_end);
	...
	public String getZtl_begin() {
		return ztl_begin;
	}
	public String getZtl_end() {
		return ztl_end;
	}
	public String getZtl_mo() {
		return ztl_mo;
	}
	...
	public void setZtl_begin(String ztl_begin) {
		this.ztl_begin = ztl_begin;
	}
	public void setZtl_end(String ztl_end) {
		this.ztl_end = ztl_end;
	}	


	public void setZtl_mo(String ztl_mo) {
		this.ztl_mo = ztl_mo;
	}
