...
public class Gdbl extends ActionSupport{
	
	private String gdbl_mo;
	...
	public String execute() throws Exception{
		...
		try {
			...
			stmt.setString("MOName", this.gdbl_mo);
	...
	public void setGdbl_mo(String gdbl_mo) {
		this.gdbl_mo = gdbl_mo;
	}	
