...
public class Rk extends ActionSupport{
	
	private String rk_pattern;

	private String rk_sn;
	...
	public String execute() throws Exception{
		...
		try {
			...
			if(this.rk_pattern.equals("lotsubmit")){
				LotSN=this.rk_sn;
			}else if(this.rk_pattern.equals("posubmit")){
				POName=this.rk_sn;
			}else{
				ProductName=this.rk_sn;
			}
			...
			stmt.setString("I_Sender", this.rk_pattern);
	...
	public String getRk_pattern() {
		return rk_pattern;
	}
	
	
	
	public String getRk_sn() {
		return rk_sn;
	}
	...
	public void setRk_pattern(String rk_pattern) {
		this.rk_pattern = rk_pattern;
	}	


	public void setRk_sn(String rk_sn) {
		this.rk_sn = rk_sn;
	}
