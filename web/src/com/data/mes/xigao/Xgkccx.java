...
public class Xgkccx extends ActionSupport{
	...
	public String execute() throws Exception{
		...
		try {
			...
			stmt=conn.prepareCall("{call Txn_TinolReserveQueryDoMethod(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
			...
			stmt.setString("ReserveDateBegin", this.begin_date);
			stmt.setString("ReserveDateEnd", this.end_date);
